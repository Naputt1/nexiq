...
This plan outlines the integration of Git functionality into the `nexu` UI, allowing users to visualize changes across different commits and the current working tree.
